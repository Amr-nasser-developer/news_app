                  ...
                  builder: (context)=> SingleChildScrollView(
                    child: Column(
                      children: [
                        ...
                        if(state is! getScienceApiDataMoreLoading &&NewsCubit.get(context).currentPageSport <= NewsCubit.get(context).totalCurrentPageSport)
                          Container(
                            width: 120.0,
                            height: 40.0,
                            ...
                            child: FlatButton(
                              onPressed: (){
                                if(NewsCubit.get(context).currentPageSport <= NewsCubit.get(context).totalCurrentPageSport)
                                  NewsCubit.get(context).getScienceDataMore(country: con);
                              },
                              child: Row(
                                children: [
                                  Text('Load More'  ),
