          ...
          child: SingleChildScrollView(
            child: Container(
              ...
              child: ConditionalBuilder(
                  condition: state is! getBusinessApiDataError,
                  builder: (context)=> ConditionalBuilder(
                      condition: state is! getBusinessApiDataLoading,
                      builder: (context)=> ConditionalBuilder(
                               ...
                               ListView.separated(
                                    shrinkWrap: true,
                                      ...
                                      itemBuilder: (context, index){
                                        return BuildArticles(business[index],context);
                                      },
                                ...
                                if(state is! getBusinessApiDataMoreLoading &&NewsCubit.get(context).currentPageBusiness <= NewsCubit.get(context).totalCurrentPageBusiness)
                                  Container(
                                    width: 120.0,
                                    height: 40.0,
                                    ...
                                    child: FlatButton(
                                      onPressed: (){
                                        if(NewsCubit.get(context).currentPageBusiness <= NewsCubit.get(context).totalCurrentPageBusiness)
                                        NewsCubit.get(context).getBusinessDataMore(country: con);
                                      },
                                      child: Row(
                                        children: [
                                          Text('Load More'  ),
                                ...
                                if(state is getBusinessApiDataMoreLoading)
